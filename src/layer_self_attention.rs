...
pub struct SelfAttention {
    ...
    #[bincode(with_serde)] w_q: Array2<f32>,
    #[bincode(with_serde)] w_k: Array2<f32>,
    #[bincode(with_serde)] w_v: Array2<f32>,

    #[serde(skip)]#[bincode(with_serde)]  cached_input: Option<Array2<f32>>,

    #[bincode(with_serde)] optimizer_w_q: Adam,
    #[bincode(with_serde)] optimizer_w_k: Adam,
    #[bincode(with_serde)] optimizer_w_v: Adam,
}
